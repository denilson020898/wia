...
var wasmBinaryFile = 'em_asm.wasm';
...
var ASM_CONSTS = {
  1960: function() {const greetings = "HELLO from EM_ASM_INT"; const byteCount = (Module.lengthBytesUTF8(greetings) + 1); const greetingsPointer = Module._malloc(byteCount); Module.stringToUTF8(greetings, greetingsPointer, byteCount); return greetingsPointer;}
};
