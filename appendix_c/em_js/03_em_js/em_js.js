...
function StringReturnValueWithNoParameters(){ const greetings = "bruh is returned."; const byteCount = (Module.lengthBytesUTF8(greetings) + 1); const greetinsPointer = Module._malloc(byteCount); Module.stringToUTF8(greetings, greetinsPointer, byteCount); return greetinsPointer; }
...
var asmLibraryArg = {
  "StringReturnValueWithNoParameters": StringReturnValueWithNoParameters,
